...
<section>
    <div class="container p-5">
        ...
        <div class="row p-3">
            <div class="col">
                <h2 class="h2">Grafico Mensual</h2>
                <div id="grafico1" style="max-width:100%; height:auto"></div>
            </div>
        </div>
        <div class="row p-3">
            <div class="col">
                <h2 class="h2">Grafico Diario</h2>
                <div id="grafico2" style="max-width:100%; height:auto"></div>
            </div>
        </div>
    </div>
</section>